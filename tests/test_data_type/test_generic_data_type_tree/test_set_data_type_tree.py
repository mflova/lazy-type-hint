...
class TestGetStrPy:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (SetDataTypeTree({1, 2}, name=NAME), f"{NAME} = Set[int]", 2),
            ...
            (SetDataTypeTree({(1, 2), (3, 4)}, name=NAME), f"{NAME} = Set[Union[{NAME}Tuple, {NAME}Tuple2]]", 2),
            (SetDataTypeTree({(1, 2), (3, 4.2)}, name=NAME), f"{NAME} = Set[Union[{NAME}Tuple, {NAME}Tuple2]]", 2),
            (SetDataTypeTree({(1, 2), (3, 4.2), (2, 3)}, name=NAME), f"{NAME} = Set[Union[{NAME}Tuple, {NAME}Tuple2, {NAME}Tuple3]]", 3),
            (SetDataTypeTree(set(), name=NAME), f"{NAME} = Set[Any]", 0),
            (SetDataTypeTree(frozenset({1}), name=NAME), f"{NAME} = FrozenSet[int]", 1),
            (SetDataTypeTree(frozenset((1, 2)), name=NAME), f"{NAME} = FrozenSet[int]", 2),
            ...
            (SetDataTypeTree(frozenset({(1, 2), (3, 4)}), name=NAME), f"{NAME} = FrozenSet[Union[{NAME}Tuple, {NAME}Tuple2]]", 2),
            (SetDataTypeTree(frozenset({(1, 2), (3, 4.2)}), name=NAME), f"{NAME} = FrozenSet[Union[{NAME}Tuple, {NAME}Tuple2]]", 2),
            (SetDataTypeTree(frozenset({(1, 2), (3, 4.2), (2, 3)}), name=NAME), f"{NAME} = FrozenSet[Union[{NAME}Tuple, {NAME}Tuple2, {NAME}Tuple3]]", 3),
