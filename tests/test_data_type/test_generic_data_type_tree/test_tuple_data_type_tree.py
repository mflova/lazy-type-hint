...
class TestGetStrPy:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (TupleDataTypeTree((1, 2), name=NAME, strategies=Strategies(tuple_size_strategy="...")), f"{NAME} = Tuple[int, ...]", 2),
            ...
            (TupleDataTypeTree(((1,2), (1,2), (1,2)), name=NAME, strategies=Strategies(tuple_size_strategy="...")), f"{NAME} = Tuple[Union[{NAME}Tuple, {NAME}Tuple2, {NAME}Tuple3], ...]", 3),
            (TupleDataTypeTree(({1, 2}, {3, 4}), name=NAME, strategies=Strategies(tuple_size_strategy="...")), f"{NAME} = Tuple[Union[{NAME}Set, {NAME}Set2], ...]", 2),
            (TupleDataTypeTree(({1, 2}, {3, 4.2}), name=NAME, strategies=Strategies(tuple_size_strategy="...")), f"{NAME} = Tuple[Union[{NAME}Set, {NAME}Set2], ...]", 2),
